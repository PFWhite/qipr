"""
Django settings for qipr project.
...
def define_env():
    ...
    os.environ['QIPR_DATABASE_NAME'] = get_config('database_name')
    os.environ['QIPR_DATABASE_USER'] = get_config('database_user')
...
DATABASES = {
	...
	'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ['QIPR_DATABASE_NAME'],
        'USER': os.environ['QIPR_DATABASE_USER'],
        'PASSWORD': os.environ['QIPR_DATABASE_PASSWORD'],
        'HOST': os.environ['QIPR_DATABASE_HOST'],
        'PORT': os.environ['QIPR_DATABASE_PORT'],
    }
}
